...
describe('10 - Implemente os casos de teste e a função `createMenu`', () => {
  it('Verifica se a função `createMenu` tem o comportamento esperado', () => { // função e testes implementados por mim
    ...
    // ```
    expect(typeof createMenu({ teste: 'testando' }).fetchMenu).toBe('function');
    ...
    // ```
    expect(createMenu({ Objeto: 'qualquer' }).fetchMenu()).toStrictEqual({ Objeto: 'qualquer' });
    ...
    // ```
    expect(createMenu({ Objeto: 'qualquer' }).consumption).toStrictEqual([]);
    ...
    // ```
    const teste = createMenu({ Objeto: 'qualquer' });
    teste.order('coxinha');
    expect(teste.consumption).toStrictEqual(['coxinha']);
    ...
    teste.order('sopa');
    teste.order('sashimi');
    expect(teste.consumption).toStrictEqual(["coxinha", "agua", "sopa", "sashimi"]);
    ...
    // ```
    const teste2 = createMenu({ Objeto: 'qualquer' });
    teste2.order('coxinha');
    teste2.order('agua');
    teste2.order('coxinha');
    expect(teste2.consumption).toStrictEqual(["coxinha", "agua", "coxinha"]);
